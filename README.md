...
| --------- | -------- | -------- |
| [`rawdata`](rawdata/) | Output data from initial processing and quality check. | 01_Data_processing_QC.R 
02_Data_Preprocess_QC_Visualization.R 
03_Imaging_Processing.R|
