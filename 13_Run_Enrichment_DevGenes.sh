...
# Neuropsy
Rscript Enrichment.r -g ASD_fMRI_DevClustered.txt -l ASD_SFARI.RData -p -b 15585 -o STATS/DISORDERS -W 5 -H 5
...
# Develop
Rscript Enrichment.r -g ASD_fMRI_DevClustered.txt -l GeneSets_Parikshak.RData -p -b 15585 -o STATS/DEVBRAIN_Parikshak -W 5 -H 5
Rscript Enrichment.r -g ASD_fMRI_DevClustered.txt -l GeneSets_Polioudakis2020.RData -p -b 15585 -o STATS/DEVBRAIN_POLIOUDAKIS -W 5 -H 5
